 ...
 plot(inflFilter$m[,1:3], col=c("navy"), ann = F, yax.flip = TRUE)
 plot(inflSmooth$s[,1:3], col=c("navy"), ann = F, yax.flip = TRUE)
 ...
 for (i in 1:3) {
   plot(inflFilter$m[,i], type = "l", col = "navy", ylab = "", xlab = "", 
        main = series_names[i], cex.main = 1.5, cex.lab = 1.3, cex.axis = 1.2)
 }
