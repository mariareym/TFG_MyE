...
# simulaciones
 ...
 lines(year, filterMCMC$f, col = "navy", type = "l", lwd = 1)
 lines(year, filterMLE$f, col = "orchid3", type = "l", lwd = 1)
 polygon(c(year, rev(year)), c(filterMCMC_lower, rev(filterMCMC_upper)), col = adjustcolor("steelblue", alpha.f = 0.2), border = NA)
 polygon(c(year, rev(year)), c(filterMLE_lower, rev(filterMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 legend("topright", legend = c("EMV", "MCMC", "IC 95% EMV", "IC 95% MCMC"), col = c("orchid", "navy", adjustcolor("orchid", alpha.f = 0.2), adjustcolor("steelblue", alpha.f = 0.2)), lwd = 1, bty = "n")
 ...
 filterMLE_upper <- filterMLE$f + qnorm(0.975) * sqrt(filterMLE_var_pred) / sqrt(132)
 ylimosa <- range(c(filterMCMC$f, filterMLE$f, filterMCMC_lower, filterMCMC_upper, filterMLE_lower, filterMLE_upper))
 par(mfrow = c(2, 1), mar = c(4, 4, 2, 1)) # 2 filas y 1 columna, con márgenes
 plot(year, filterMLE$f, col = "orchid", type = "l", lwd = 1, main = "", xlab = "", ylab = "Inflación salarial (%)", ylim = ylimosa)
 polygon(c(year, rev(year)), c(filterMLE_lower, rev(filterMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 lines(year, filterMLE$f, col = "orchid", lwd = 1)
 legend("topright", legend = c("EMV", "IC 95% EMV"), col = c("orchid", adjustcolor("orchid", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("orchid", alpha.f = 0.2)), bty = "n")
 plot(year, filterMCMC$f, col = "navy", type = "l", lwd = 1, main = "", xlab = "Año", ylab = "Inflación salarial (%)", ylim = ylimosa)
 polygon(c(year, rev(year)), c(filterMCMC_lower, rev(filterMCMC_upper)), col = adjustcolor("steelblue", alpha.f = 0.2), border = NA)
 lines(year, filterMCMC$f, col = "navy", lwd = 1)
 legend("topright", legend = c("MCMC", "IC 95% MCMC"), col = c("navy", adjustcolor("steelblue", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("steelblue", alpha.f = 0.2)), bty = "n")
 ...
 plot(year1, smoothMLE$s[,1], col = "orchid", type = "l", lwd = 1, main = "", xlab = "", ylab = "", ylim = ylim0)
 lines(year1, smoothMCMC$s[,1], col = "navy", type = "l", lwd = 1)
 polygon(c(year1, rev(year1)), c(smoothMLE_lower, rev(smoothMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 ...
 legend("topright", legend = c("EMV", "MCMC", "Intervalo de Confianza 95% (EMV)", "Intervalo de Confianza 95% (MCMC)"), col = c("orchid", "navy", NA, NA), lwd = c(1, 1, NA, NA), lty = c(1, 1, NA, NA), fill = c(NA, NA, adjustcolor("orchid", alpha.f = 0.2), adjustcolor("steelblue", alpha.f = 0.2)), bty = "n")
 
 smoothMCMC_var <- dlmSvd2var(smoothMCMC$U.S, smoothMCMC$D.S)
 smoothMLE_var <- dlmSvd2var(smoothMLE$U.S, smoothMLE$D.S)
 smoothMCMC_var_diag <- sapply(smoothMCMC_var, function(x) x[1, 1])
 smoothMLE_var_diag <- sapply(smoothMLE_var, function(x) x[1, 1])
 smoothMCMC_lower <- smoothMCMC$s[,1] - qnorm(0.975) * sqrt(smoothMCMC_var_diag)/sqrt(132)
 smoothMCMC_upper <- smoothMCMC$s[,1] + qnorm(0.975) * sqrt(smoothMCMC_var_diag)/sqrt(132)
 smoothMLE_lower <- smoothMLE$s[,1] - qnorm(0.975) * sqrt(smoothMLE_var_diag)/sqrt(132)
 smoothMLE_upper <- smoothMLE$s[,1] + qnorm(0.975) * sqrt(smoothMLE_var_diag)/sqrt(132)
 ylim0 <- range(c(smoothMLE$s[,1], smoothMCMC$s[,1], smoothMCMC_lower, smoothMCMC_upper, smoothMLE_lower, smoothMLE_upper))
 par(mfrow = c(2, 1), mar = c(4, 4, 2, 1)) # 2 filas y 1 columna, con márgenes
 plot(year1, smoothMLE$s[,1], col = "orchid", type = "l", lwd = 1, main = "", xlab = "", ylab = "", ylim = ylim0)
 polygon(c(year1, rev(year1)), c(smoothMLE_lower, rev(smoothMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 lines(year1, smoothMLE$s[,1], col = "orchid", lwd = 1)
 mtext(expression(beta[0]), side = 2, line = 2.5)
 legend("topright", legend = c("EMV", "Intervalo de Confianza 95% (EMV)"), col = c("orchid", adjustcolor("orchid", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("orchid", alpha.f = 0.2)), bty = "n")
 plot(year1, smoothMCMC$s[,1], col = "navy", type = "l", lwd = 1, main = "", xlab = "Año", ylab = "", ylim = ylim0)
 polygon(c(year1, rev(year1)), c(smoothMCMC_lower, rev(smoothMCMC_upper)), col = adjustcolor("steelblue", alpha.f = 0.2), border = NA)
 lines(year1, smoothMCMC$s[,1], col = "navy", lwd = 1)
 mtext(expression(beta[0]), side = 2, line = 2.5)
 legend("topright", legend = c("MCMC", "Intervalo de Confianza 95% (MCMC)"), col = c("navy", adjustcolor("steelblue", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("steelblue", alpha.f = 0.2)), bty = "n")
 ...
 plot(year1, smoothMLE$s[,2], col = "orchid", type = "l", lwd = 1, main = "", xlab = "", ylab = "", ylim = ylim0)
 lines(year1, smoothMCMC$s[,2], col = "navy", type = "l", lwd = 1)
 polygon(c(year1, rev(year1)), c(smoothMLE_lower, rev(smoothMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 polygon(c(year1, rev(year1)), c(smoothMCMC_lower, rev(smoothMCMC_upper)), col = adjustcolor("steelblue", alpha.f = 0.2), border = NA)
 ...
 smoothMCMC_var_diag <- sapply(smoothMCMC_var, function(x) x[2, 2])
 smoothMLE_var_diag <- sapply(smoothMLE_var, function(x) x[2, 2])
 smoothMCMC_lower <- smoothMCMC$s[,2] - qnorm(0.975) * sqrt(smoothMCMC_var_diag)/sqrt(132)
 smoothMCMC_upper <- smoothMCMC$s[,2] + qnorm(0.975) * sqrt(smoothMCMC_var_diag)/sqrt(132)
 smoothMLE_lower <- smoothMLE$s[,2] - qnorm(0.975) * sqrt(smoothMLE_var_diag)/sqrt(132)
 smoothMLE_upper <- smoothMLE$s[,2] + qnorm(0.975) * sqrt(smoothMLE_var_diag)/sqrt(132)
 ylim0 <- range(c(smoothMLE$s[,2], smoothMCMC$s[,2], smoothMCMC_lower, smoothMCMC_upper, smoothMLE_lower, smoothMLE_upper))
 par(mfrow = c(2, 1), mar = c(4, 4, 2, 1)) # 2 filas y 1 columna, con márgenes
 plot(year1, smoothMLE$s[,2], col = "orchid", type = "l", lwd = 1, main = "", xlab = "", ylab = "", ylim = ylim0)
 polygon(c(year1, rev(year1)), c(smoothMLE_lower, rev(smoothMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 lines(year1, smoothMLE$s[,2], col = "orchid", lwd = 1)
 mtext(expression(beta[1]), side = 2, line = 2.5)
 legend("topright", legend = c("EMV", "Intervalo de Confianza 95% (EMV)"), col = c("orchid", adjustcolor("orchid", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("orchid", alpha.f = 0.2)), bty = "n")
 plot(year1, smoothMCMC$s[,2], col = "navy", type = "l", lwd = 1, main = "", xlab = "Año", ylab = "", ylim = ylim0)
 polygon(c(year1, rev(year1)), c(smoothMCMC_lower, rev(smoothMCMC_upper)), col = adjustcolor("steelblue", alpha.f = 0.2), border = NA)
 lines(year1, smoothMCMC$s[,2], col = "navy", lwd = 1)
 mtext(expression(beta[1]), side = 2, line = 2.5)
 legend("topright", legend = c("MCMC", "Intervalo de Confianza 95% (MCMC)"), col = c("navy", adjustcolor("steelblue", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("steelblue", alpha.f = 0.2)), bty = "n")
 ...
 ylim0 <- range(c(smoothMLE$s[,3], smoothMCMC$s[,2], smoothMCMC_lower, smoothMCMC_upper, smoothMLE_lower, smoothMLE_upper))
 plot(year1, smoothMLE$s[,3], col = "orchid", type = "l", lwd = 1, main = "", xlab = "", ylab = "", ylim = ylim0)
 lines(year1, smoothMCMC$s[,3], col = "navy", type = "l", lwd = 1)
 polygon(c(year1, rev(year1)), c(smoothMLE_lower, rev(smoothMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 polygon(c(year1, rev(year1)), c(smoothMCMC_lower, rev(smoothMCMC_upper)), col = adjustcolor("steelblue", alpha.f = 0.2), border = NA)
 ...
 smoothMCMC_var_diag <- sapply(smoothMCMC_var, function(x) x[3, 3])
 smoothMLE_var_diag <- sapply(smoothMLE_var, function(x) x[3, 3])
 smoothMCMC_lower <- smoothMCMC$s[,3] - qnorm(0.975) * sqrt(smoothMCMC_var_diag)/sqrt(132)
 smoothMCMC_upper <- smoothMCMC$s[,3] + qnorm(0.975) * sqrt(smoothMCMC_var_diag)/sqrt(132)
 smoothMLE_lower <- smoothMLE$s[,3] - qnorm(0.975) * sqrt(smoothMLE_var_diag)/sqrt(132)
 smoothMLE_upper <- smoothMLE$s[,3] + qnorm(0.975) * sqrt(smoothMLE_var_diag)/sqrt(132)
 ylim0 <- range(c(smoothMLE$s[,3], smoothMCMC$s[,3], smoothMCMC_lower, smoothMCMC_upper, smoothMLE_lower, smoothMLE_upper))
 par(mfrow = c(2, 1), mar = c(4, 4, 2, 1)) # 2 filas y 1 columna, con márgenes
 plot(year1, smoothMLE$s[,3], col = "orchid", type = "l", lwd = 1, main = "", xlab = "", ylab = "", ylim = ylim0)
 polygon(c(year1, rev(year1)), c(smoothMLE_lower, rev(smoothMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 lines(year1, smoothMLE$s[,3], col = "orchid", lwd = 1)
 mtext(expression(beta[2]), side = 2, line = 2.5)
 legend("topright", legend = c("EMV", "Intervalo de Confianza 95% (EMV)"), col = c("orchid", adjustcolor("orchid", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("orchid", alpha.f = 0.2)), bty = "n")
 plot(year1, smoothMCMC$s[,3], col = "navy", type = "l", lwd = 1, main = "", xlab = "Año", ylab = "", ylim = ylim0)
 polygon(c(year1, rev(year1)), c(smoothMCMC_lower, rev(smoothMCMC_upper)), col = adjustcolor("steelblue", alpha.f = 0.2), border = NA)
 lines(year1, smoothMCMC$s[,3], col = "navy", lwd = 1)
 mtext(expression(beta[2]), side = 2, line = 2.5)
 legend("topright", legend = c("MCMC", "Intervalo de Confianza 95% (MCMC)"), col = c("navy", adjustcolor("steelblue", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("steelblue", alpha.f = 0.2)), bty = "n")
 ...
 plot(year1, filterMLE$m[,1], col = "orchid", type = "l", lwd = 1, main = "", xlab = "", ylab = "", ylim = ylim0)
 lines(year1, filterMCMC$m[,1], col = "navy", type = "l", lwd = 1)
 polygon(c(year1, rev(year1)), c(filterMLE_lower, rev(filterMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 ...
 filterMCMC_var_diag <- sapply(filterMCMC_var, function(x) x[1, 1])
 filterMLE_var_diag <- sapply(filterMLE_var, function(x) x[1, 1])
 filterMCMC_lower <- filterMCMC$m[,1] - qnorm(0.975) * sqrt(filterMCMC_var_diag)/sqrt(132)
 filterMCMC_upper <- filterMCMC$m[,1] + qnorm(0.975) * sqrt(filterMCMC_var_diag)/sqrt(132)
 filterMLE_lower <- filterMLE$m[,1] - qnorm(0.975) * sqrt(filterMLE_var_diag)/sqrt(132)
 filterMLE_upper <- filterMLE$m[,1] + qnorm(0.975) * sqrt(filterMLE_var_diag)/sqrt(132)
 ylim0 <- range(c(filterMLE$m[,1], filterMCMC$m[,1], filterMCMC_lower, filterMCMC_upper, filterMLE_lower, filterMLE_upper))
 par(mfrow = c(2, 1), mar = c(4, 4, 2, 1)) # 2 filas y 1 columna, con márgenes
 plot(year1, filterMLE$m[,1], col = "orchid", type = "l", lwd = 1, main = "", xlab = "", ylab = "", ylim = ylim0)
 polygon(c(year1, rev(year1)), c(filterMLE_lower, rev(filterMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 lines(year1, filterMLE$m[,1], col = "orchid", lwd = 1)
 mtext(expression(beta[0]), side = 2, line = 2.5)
 legend("topright", legend = c("EMV", "Intervalo de Confianza 95% (EMV)"), col = c("orchid", adjustcolor("orchid", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("orchid", alpha.f = 0.2)), bty = "n")
 plot(year1, filterMCMC$m[,1], col = "navy", type = "l", lwd = 1, main = "", xlab = "Año", ylab = "", ylim = ylim0)
 polygon(c(year1, rev(year1)), c(filterMCMC_lower, rev(filterMCMC_upper)), col = adjustcolor("steelblue", alpha.f = 0.2), border = NA)
 lines(year1, filterMCMC$m[,1], col = "navy", lwd = 1)
 mtext(expression(beta[0]), side = 2, line = 2.5)
 legend("topright", legend = c("MCMC", "Intervalo de Confianza 95% (MCMC)"), col = c("navy", adjustcolor("steelblue", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("steelblue", alpha.f = 0.2)), bty = "n")
 ...
 plot(year1, filterMLE$m[,2], col = "orchid", type = "l", lwd = 1, main = "", xlab = "", ylab = "", ylim = ylim0)
 lines(year1, filterMCMC$m[,2], col = "navy", type = "l", lwd = 1)
 polygon(c(year1, rev(year1)), c(filterMLE_lower, rev(filterMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 polygon(c(year1, rev(year1)), c(filterMCMC_lower, rev(filterMCMC_upper)), col = adjustcolor("steelblue", alpha.f = 0.2), border = NA)
 mtext(expression(beta[1]), side = 2, line = 2.5)
 legend("topright", legend = c("EMV", "MCMC", "Intervalo de Confianza 95% (EMV)", "Intervalo de Confianza 95% (MCMC)"), col = c("orchid","navy", NA, NA), lwd = c(1, 1, NA, NA), lty = c(1, 1, NA, NA), fill = c(NA, NA, adjustcolor("orchid", alpha.f = 0.2), adjustcolor("steelblue", alpha.f = 0.2)), bty = "n")
 ...
 filterMCMC_var_diag <- sapply(filterMCMC_var, function(x) x[2, 2])
 filterMLE_var_diag <- sapply(filterMLE_var, function(x) x[2, 2])
 filterMCMC_lower <- filterMCMC$m[,2] - qnorm(0.975) * sqrt(filterMCMC_var_diag)/sqrt(132)
 filterMCMC_upper <- filterMCMC$m[,2] + qnorm(0.975) * sqrt(filterMCMC_var_diag)/sqrt(132)
 filterMLE_lower <- filterMLE$m[,2] - qnorm(0.975) * sqrt(filterMLE_var_diag)/sqrt(132)
 filterMLE_upper <- filterMLE$m[,2] + qnorm(0.975) * sqrt(filterMLE_var_diag)/sqrt(132)
 ylim0 <- range(c(filterMLE$m[,2], filterMCMC$m[,2], filterMCMC_lower, filterMCMC_upper, filterMLE_lower, filterMLE_upper))
 par(mfrow = c(2, 1), mar = c(4, 4, 2, 1)) # 2 filas y 1 columna, con márgenes
 plot(year1, filterMLE$m[,2], col = "orchid", type = "l", lwd = 1, main = "", xlab = "", ylab = "", ylim = ylim0)
 polygon(c(year1, rev(year1)), c(filterMLE_lower, rev(filterMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 lines(year1, filterMLE$m[,2], col = "orchid", lwd = 1)
 mtext(expression(beta[1]), side = 2, line = 2.5)
 legend("topright", legend = c("EMV", "Intervalo de Confianza 95% (EMV)"), col = c("orchid", adjustcolor("orchid", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("orchid", alpha.f = 0.2)), bty = "n")
 plot(year1, filterMCMC$m[,2], col = "navy", type = "l", lwd = 1, main = "", xlab = "Año", ylab = "", ylim = ylim0)
 polygon(c(year1, rev(year1)), c(filterMCMC_lower, rev(filterMCMC_upper)), col = adjustcolor("steelblue", alpha.f = 0.2), border = NA)
 lines(year1, filterMCMC$m[,2], col = "navy", lwd = 1)
 mtext(expression(beta[1]), side = 2, line = 2.5)
 legend("topright", legend = c("MCMC", "Intervalo de Confianza 95% (MCMC)"), col = c("navy", adjustcolor("steelblue", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("steelblue", alpha.f = 0.2)), bty = "n")
 ...
 plot(year1, filterMLE$m[,3], col = "orchid", type = "l", lwd = 1, main = "", xlab = "", ylab = "", ylim = ylim0)
 lines(year1, filterMCMC$m[,3], col = "navy", type = "l", lwd = 1)
 polygon(c(year1, rev(year1)), c(filterMLE_lower, rev(filterMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 polygon(c(year1, rev(year1)), c(filterMCMC_lower, rev(filterMCMC_upper)), col = adjustcolor("steelblue", alpha.f = 0.2), border = NA)
 mtext(expression(beta[2]), side = 2, line = 2.5)
 legend("topright", legend = c("EMV", "MCMC", "Intervalo de Confianza 95% (EMV)", "Intervalo de Confianza 95% (MCMC)"), col = c("orchid","navy", NA, NA), lwd = c(1, 1, NA, NA), lty = c(1, 1, NA, NA), fill = c(NA, NA, adjustcolor("orchid", alpha.f = 0.2), adjustcolor("steelblue", alpha.f = 0.2)), bty = "n")
 ...
 filterMCMC_var_diag <- sapply(filterMCMC_var, function(x) x[3, 3])
 filterMLE_var_diag <- sapply(filterMLE_var, function(x) x[3, 3])
 filterMCMC_lower <- filterMCMC$m[,3] - qnorm(0.975) * sqrt(filterMCMC_var_diag)/sqrt(132)
 filterMCMC_upper <- filterMCMC$m[,3] + qnorm(0.975) * sqrt(filterMCMC_var_diag)/sqrt(132)
 filterMLE_lower <- filterMLE$m[,3] - qnorm(0.975) * sqrt(filterMLE_var_diag)/sqrt(132)
 filterMLE_upper <- filterMLE$m[,3] + qnorm(0.975) * sqrt(filterMLE_var_diag)/sqrt(132)
 ylim0 <- range(c(filterMLE$m[,3], filterMCMC$m[,3], filterMCMC_lower, filterMCMC_upper, filterMLE_lower, filterMLE_upper))
 par(mfrow = c(2, 1), mar = c(4, 4, 2, 1)) # 2 filas y 1 columna, con márgenes
 plot(year1, filterMLE$m[,3], col = "orchid", type = "l", lwd = 1, main = "", xlab = "", ylab = "", ylim = ylim0)
 polygon(c(year1, rev(year1)), c(filterMLE_lower, rev(filterMLE_upper)), col = adjustcolor("orchid", alpha.f = 0.2), border = NA)
 lines(year1, filterMLE$m[,3], col = "orchid", lwd = 1)
 mtext(expression(beta[2]), side = 2, line = 2.5)
 legend("topright", legend = c("EMV", "Intervalo de Confianza 95% (EMV)"), col = c("orchid", adjustcolor("orchid", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("orchid", alpha.f = 0.2)), bty = "n")
 plot(year1, filterMCMC$m[,3], col = "navy", type = "l", lwd = 1, main = "", xlab = "Año", ylab = "", ylim = ylim0)
 polygon(c(year1, rev(year1)), c(filterMCMC_lower, rev(filterMCMC_upper)), col = adjustcolor("steelblue", alpha.f = 0.2), border = NA)
 lines(year1, filterMCMC$m[,3], col = "navy", lwd = 1)
 mtext(expression(beta[2]), side = 2, line = 2.5)
 legend("topright", legend = c("MCMC", "Intervalo de Confianza 95% (MCMC)"), col = c("navy", adjustcolor("steelblue", alpha.f = 0.2)), lwd = c(1, NA), lty = c(1, NA), fill = c(NA, adjustcolor("steelblue", alpha.f = 0.2)), bty = "n")
